...
// In a real production environment, these should be in a .env file.
// Used here directly per prompt instructions.
...
export const GEMINI_API_KEY = "AIzaSyC-qrXJPDKbykFs4HAXaXfOKnMNOKmUtw8";
